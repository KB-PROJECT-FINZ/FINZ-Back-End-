...
//            System.out.println("✅ [SUB] Expire Time (ms): " + subToken.getExpireTime());
                ...
                TokenInfo kiwoomToken = TokenManager.getTokenInfo(TokenManager.TokenType.KIWOOM);
                System.out.println("✅ [KIWOOM] Access Token: " + kiwoomToken.getAccessToken());
                System.out.println("✅ [KIWOOM] Approval Key: " + kiwoomToken.getApprovalKey());
                System.out.println("✅ [KIWOOM] Expire Time (ms): " + kiwoomToken.getExpireTime());
...
//            JsonNode output = MinuteChartApiTest.getMinuteChartTest("005930");
//            System.out.println(output);
